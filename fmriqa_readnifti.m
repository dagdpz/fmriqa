function [out,pixdim,rotate,dtype] = fmriqa_readnifti(filename,volnum)
% READNIFTI  - Read MRI files in the NIFTI format
%
%    usage: 
%            [data,pixdim,orient,dtype] = fmriqa_readnifti(filename);
%            [data,pixdim,orient,dtype] = fmriqa_readnifti(filename,volumenum);
%
...
RESHAPE_DATA = 1; % When this flag is set to 1 the data is reshaped into
                  % an n-dimensional matrix. Otherwise fmriqa_readnifti will
